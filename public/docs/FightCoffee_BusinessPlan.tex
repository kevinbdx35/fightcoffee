% ─────────────────────────────────────────────────────────────────────────────
%  FIGHTCOFFEE — Business Plan v2.3 (analyse financière approfondie mars 2026)
...
\begin{center}
  ...
  {\small\color{fc-ink3} Document confidentiel — v2.3 · Mars 2026}\\[4pt]
...
Licence boissons (offre soir) & \textcolor{green!60!black}{FAIBLE} & Licence III (boissons fermentées : bières, vins, cidres) — simple déclaration en mairie, sans transfert requis. Licence IV délibérément évitée. \\
\bottomrule
\end{tabular}
\end{center}
