...
La rentabilité du site de Pleurtuit (8–12\% de marge nette en An 3) est réelle mais modeste. \textbf{La valeur du projet pour un investisseur réside dans la duplication} — Phase 2 vers Vannes et Brest, Phase 3 vers un réseau national franchisé. Le site pilote est le proof of concept qui déclenche la mise à l'échelle. C'est un investissement dans un concept scalable, pas dans un lieu unique.
