% ─────────────────────────────────────────────────────────────────────────────
%  FIGHTCOFFEE — Business Plan v2.0 (tarification révisée mars 2026)
...
\begin{center}
  ...
  {\small\color{fc-ink3} Document confidentiel — v2.0 · Mars 2026}\\[4pt]
...
\midrule
Enfants (6–12 ans) & \redcell{45–55 €} & 2 cours/sem · stages vacances \\
\rowcolor{fc-bg2} Ados (13–17 ans) & \redcell{55–65 €} & 3 cours/sem · sparring encadré \\
...
\rowcolor{fc-bg2} Cours enfants \& ados & 9\% & 28 k€ & 40 k€ & 55 k€ \\
...
\rowcolor{fc-bg2} Panier moyen / mois & 90 € & \redcell{130 €} & 170 € \\
CA Année 1 & \textasciitilde200 k€ & \redcell{\textasciitilde310 k€} & \textasciitilde450 k€ \\
\rowcolor{fc-bg2} CA Année 2 & \textasciitilde280 k€ & \redcell{\textasciitilde430 k€} & \textasciitilde620 k€ \\
CA Année 3 & \textasciitilde380 k€ & \redcell{\textasciitilde580 k€} & \textasciitilde840 k€ \\
\rowcolor{fc-bg2} Marge nette An 3 & 3–6\% & \redcell{8–12\%} & 16–22\% \\
Break-even & 42–54 mois & \redcell{24–30 mois} & 14–18 mois \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{itemize}
  \item Étude d'un second site côtier (Vannes ou Brest — premier marché hors bassin Saint-Malo/Dinard)
